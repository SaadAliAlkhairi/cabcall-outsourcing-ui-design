    ...
    <Box>
      ...
      >
        <Container sx={{width: 'fit-content', /*mx: '40px'*/}}>
          <Box sx={{marginX: 'auto', maxWidth: '595px', textAlign: {xs: 'center', lg: 'left'}}}>
            ...
            With CabCall, we drive your business forward. Leave the management of your inbound calls to us, so you can focus on expanding your client base and nurturing your business. Enjoy around-the-clock professional call handling, all at a fraction of the cost compared to establishing your own in-house call center.
            </Typography>
          </Box>
        </Container>
        <Box sx={{marginX: 'auto',
        marginTop: {
          ...
          <img src={successImage} style={{maxHeight: '250px', borderRadius: '30px'}}/>
        </Box>
      </Box>
    </Box>
  );
