    ...
    >
      <Box sx={{ marginBottom: "100px" }}>
        ...
        <Typography variant="body1" sx={{ maxWidth: "65%", marginX: "auto" }}>
          Our CabCall service offers 24/7 customer support by highly trained
          agents. With years of industry experience, we're known for reliable
          and affordable CabCall services, earning trust in excellent customer
          care.
        </Typography>
      </Box>
